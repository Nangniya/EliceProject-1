...
export declare const UsersSchema: import("mongoose").Schema<Products, import("mongoose").Model<Products, any, any, any, Document<unknown, any, Products> & Omit<Products & {
