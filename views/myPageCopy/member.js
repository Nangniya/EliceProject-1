...
async function getUser() {
  ...
  // 수정에 이벤트리스너 부여
  document.querySelector('#modify-user-btn').addEventListener('click', () => modifyUser(userId));
  // 탈퇴에 이벤트리스너 부여
  document.querySelector('#delete-user-btn').addEventListener('click', () => deleteUser(userId));
}
